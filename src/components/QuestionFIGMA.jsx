...
function QuestionFIGMA() {
    ...
    function handleAnswerSubmit(isCorrect, e){
        ...
        setTimeout(() => {
            if(preguntaActual === askFIGMA.length -1 ){
                setIsFinished(true);
            } else {
    ...
    return (
        <main className='app'>
            ...
            <DivTitle>
                <Image className='imgQuestion' src="https://res.cloudinary.com/sarapalacio01/image/upload/v1645318305/Quiz-Reto2/Character4_tp7klz.png" />
                <Titulo>{askFIGMA[preguntaActual].question}</Titulo>
            </DivTitle>
            
            <div>
                {askFIGMA[preguntaActual].opciones.map((resp) => (
            ...
            <div>
                <span>Pregunta {preguntaActual +1 } de</span> {askFIGMA.length}
            </div>
